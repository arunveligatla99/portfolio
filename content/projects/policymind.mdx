...
highlights:
  ...
  - 'Compliance-guard agent applies NLP-based NLI hallucination verification with 100% recall on escalation-critical queries, refusing rather than guessing when the retrieved context does not support an answer.'
