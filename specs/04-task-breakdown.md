...
- [x] **T-001** — Scaffold Next.js 15 + TypeScript strict + Tailwind v4
  - **deps:** none
...
- [x] **T-007** — Author 5 project MDX files (placeholders allowed, but real metrics where known)
  - **deps:** T-006
...
- [x] **T-014** — `/contact` with form + `/api/contact` Resend stub
  - **deps:** T-005
